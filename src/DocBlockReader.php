...
class DocBlockReader
{
    ...
    public function __construct()
    {
        ...
        if ($count === 0) {
            ...
            if ($arguments[0] instanceof \ReflectionMethod) {
                $reflection = $arguments[0];
            } else {
        ...
        $this->rawDocBlock = is_object($reflection) ? $reflection->getDocComment() : $reflection;
